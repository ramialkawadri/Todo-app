...
exports.toggleTodo = exports.removeTodo = exports.createTodo = exports.getTodos = exports.loadTodos = undefined;
...
var createTodo = function createTodo(todoText) {
  todos.push({
    text: todoText,
    completed: false,
    id: (0, _uuid2.default)()
...
var findTodoIndex = function findTodoIndex(todos, id) {
...
var findTodo = function findTodo(todos, id) {
...
var removeTodo = function removeTodo(id) {
  var todoIndex = findTodoIndex(todos, id);
...
exports.generateSummaryDom = exports.generateTodoDom = exports.renderTodos = undefined;
...
var renderTodos = function renderTodos() {
  ...
  var summary = generateSummaryDom(incompleteTodos);
  ...
  if (filteredTodos.length > 0) {
    filteredTodos.forEach(function (todo) {
      var todoEl = generateTodoDom(todo);
...
var generateTodoDom = function generateTodoDom(todo) {
  ...
  var todoTextEl = document.createElement('span');
